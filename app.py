...
def Menu():
    st.write("Please Select the mode of operation:-")
    st.write("1) Give Input.")
    st.write("2) Initiate Key Generation Process.")
    st.write("3) Initiate RSA Encryption For Assymetric Common Key sharing.")
    st.write("4) Initiate Symmetric Encryption for conversation after key sharing.")
    st.write("5) Decrypt Asymmetrically shared common key.")
    st.write("6) Decrypt message sent through Symmetric Conversation.")
    st.write("7) Exit the program :[.")
    ...
    try:
        while die:
            ...
            if choice == 1:
                ...
                st.write("This choice is not in the menu. Try Again!!!")
